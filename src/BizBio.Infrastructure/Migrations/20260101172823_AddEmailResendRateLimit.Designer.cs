...
namespace BizBio.Infrastructure.Migrations
{
    ...
    [Migration("20260101172823_AddEmailResendRateLimit")]
    partial class AddEmailResendRateLimit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizBio.Core.Entities.User", b =>
                {
                    ...
                    b.Property<int>("EmailResendAttempts")
                        .HasColumnType("int");

                    b.Property<DateTime?>("EmailResendAttemptsResetAt")
                        .HasColumnType("datetime(6)");
