<template>
  <div>
    <section class="min-h-screen bg-gradient-to-br from-[var(--light-background-color)] to-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div class="absolute bottom-20 left-10 w-96 h-96 bg-[var(--accent3-color)] rounded-full opacity-10 blur-3xl"></div>
      ...
      <div class="max-w-md w-full relative z-10">
        ...
        <div class="text-center mb-8">
          <div class="flex justify-center mb-6">
            <div class="bg-[var(--primary-color)] bg-opacity-10 rounded-full p-4">
              <i class="fas fa-sign-in-alt text-[var(--primary-color)] text-5xl"></i>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div v-if="showResendVerification" class="mb-6 bg-[var(--accent4-color)] bg-opacity-10 border-2 border-[var(--accent4-color)] rounded-lg p-4">
          ...
          <form @submit.prevent="handleLogin" class="space-y-6">
            ...
            <div>
              <div class="flex items-center justify-between mb-2">
                <label for="password" class="block text-sm font-semibold text-[var(--dark-text-color)] font-[var(--font-family-body)]">
                  Password
                </label>
                <NuxtLink
                  to="/forgot-password"
